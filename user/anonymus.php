                ...
                <div class="row">
                    ...
                    <div class="col col-sm-12 col-12 col-xs-12 mt-4">
                        <form method="POST" action="../ride/ride.php">
                            ...
                            <input type="submit" class="btn btn-success  pl-4 pr-4 mt-4" name="submit"  value='book' id="books" style="display:none;">
                            <button  class="btn btn-success  pl-4 pr-4 mt-4" value="Calculate Fare" id="submit" >Calculate Fare</button>
                        </form>
